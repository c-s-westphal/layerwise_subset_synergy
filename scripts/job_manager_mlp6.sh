...
number=$SGE_TASK_ID
paramfile="scripts/jobs_mlp6.txt"
...
date
echo "Training completed successfully: MLP6 | Seed $seed"
...
checkpoint_dir="checkpoints/mlp6_seed${seed}"
...
date
echo "Evaluation completed successfully: MLP6 | Seed $seed"
