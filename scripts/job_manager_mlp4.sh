...
number=$SGE_TASK_ID
paramfile="scripts/jobs_mlp4.txt"
...
date
echo "Training completed successfully: MLP4 | Seed $seed"
...
checkpoint_dir="checkpoints/mlp4_seed${seed}"
...
date
echo "Evaluation completed successfully: MLP4 | Seed $seed"
