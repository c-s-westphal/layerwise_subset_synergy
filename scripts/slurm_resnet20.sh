...
#SBATCH --array=1-10
#SBATCH --output=logs/resnet20_%A_%a.out
#SBATCH --error=logs/resnet20_%A_%a.err
set -euo pipefail
...
date
echo "Training: ResNet20 | Seed: $seed"
...
date
echo "Training completed successfully: ResNet20 | Seed $seed"
...
checkpoint_dir="checkpoints/resnet20_seed${seed}"
...
date
echo "Evaluation completed successfully: ResNet20 | Seed $seed"
