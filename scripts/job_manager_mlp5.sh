...
number=$SGE_TASK_ID
paramfile="scripts/jobs_mlp5.txt"
...
date
echo "Training completed successfully: MLP5 | Seed $seed"
...
checkpoint_dir="checkpoints/mlp5_seed${seed}"
...
date
echo "Evaluation completed successfully: MLP5 | Seed $seed"
