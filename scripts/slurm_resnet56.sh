...
#SBATCH --array=1-10
#SBATCH --output=logs/resnet56_%A_%a.out
#SBATCH --error=logs/resnet56_%A_%a.err
set -euo pipefail
...
date
echo "Training: ResNet56 | Seed: $seed"
...
date
echo "Training completed successfully: ResNet56 | Seed $seed"
...
checkpoint_dir="checkpoints/resnet56_seed${seed}"
...
date
echo "Evaluation completed successfully: ResNet56 | Seed $seed"
