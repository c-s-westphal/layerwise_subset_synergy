...
#SBATCH --array=1-10
#SBATCH --output=logs/vgg13_%A_%a.out
#SBATCH --error=logs/vgg13_%A_%a.err
set -euo pipefail
...
date
echo "Training completed successfully: VGG13 | Seed $seed"
...
checkpoint_dir="checkpoints/vgg13_seed${seed}"
