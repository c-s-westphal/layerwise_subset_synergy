...
#SBATCH --array=1-10
#SBATCH --output=logs/vgg19_%A_%a.out
#SBATCH --error=logs/vgg19_%A_%a.err
set -euo pipefail
...
date
echo "Training completed successfully: VGG19 | Seed $seed"
...
checkpoint_dir="checkpoints/vgg19_seed${seed}"
...
date
echo "Evaluation completed successfully: VGG19 | Seed $seed"
