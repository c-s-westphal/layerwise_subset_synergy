...
#SBATCH --gres=gpu:1
#SBATCH --job-name=vgg9
#SBATCH --array=1-10
#SBATCH --output=logs/vgg9_%A_%a.out
#SBATCH --error=logs/vgg9_%A_%a.err
set -euo pipefail
...
checkpoint_dir="checkpoints/vgg9_seed${seed}"
...
date
echo "Evaluation completed successfully: VGG9 | Seed $seed"
