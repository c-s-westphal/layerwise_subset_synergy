...
#SBATCH --gres=gpu:1
#SBATCH --job-name=resnet74
#SBATCH --array=1-10
#SBATCH --output=logs/resnet74_%A_%a.out
#SBATCH --error=logs/resnet74_%A_%a.err
set -euo pipefail
...
date
echo "Training: ResNet74 | Seed: $seed"
...
date
echo "Training completed successfully: ResNet74 | Seed $seed"
...
checkpoint_dir="checkpoints/resnet74_seed${seed}"
...
date
echo "Evaluation completed successfully: ResNet74 | Seed $seed"
