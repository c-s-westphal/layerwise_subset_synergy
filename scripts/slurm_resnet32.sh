...
#SBATCH --gres=gpu:1
#SBATCH --job-name=resnet32
#SBATCH --array=1-10
#SBATCH --output=logs/resnet32_%A_%a.out
#SBATCH --error=logs/resnet32_%A_%a.err
set -euo pipefail
...
date
echo "Training: ResNet32 | Seed: $seed"
...
date
echo "Training completed successfully: ResNet32 | Seed $seed"
...
checkpoint_dir="checkpoints/resnet32_seed${seed}"
...
date
echo "Evaluation completed successfully: ResNet32 | Seed $seed"
