...
#SBATCH --array=1-10
#SBATCH --output=logs/vgg16_%A_%a.out
#SBATCH --error=logs/vgg16_%A_%a.err
set -euo pipefail
...
date
echo "Training completed successfully: VGG16 | Seed $seed"
...
checkpoint_dir="checkpoints/vgg16_seed${seed}"
...
date
echo "Evaluation completed successfully: VGG16 | Seed $seed"
