...
number=$SGE_TASK_ID
paramfile="scripts/jobs_mlp3.txt"
...
date
echo "Training completed successfully: MLP3 | Seed $seed"
...
checkpoint_dir="checkpoints/mlp3_seed${seed}"
...
date
echo "Evaluation completed successfully: MLP3 | Seed $seed"
